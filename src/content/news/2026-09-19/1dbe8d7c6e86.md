...
originalUrl: "https://techcrunch.com/2026/09/18/world-model-companies-are-keeping-a-lot-of-secrets/"
date: "2026-09-18T23:26:04.076Z"
---
...
本周，我在 All In 大会（与同名播客无关）上主持了一个关于“世界模型”的圆桌讨论，这让我有机会深入探究 AI 领域最神秘的角落之一。该领域的主要参与者是 Yann LeCun 的 AMI Labs 和李飞飞的 World Labs——尽管这两家公司都积累了极高的关注度和资金，但在“尝试盈利”这一指标上，它们的排名却相当靠后。
...
这种保密甚至延伸到了这些公司的供应商身上。在同一场会议的间隙，我采访了 Physicl 的首席执行官 Alex de Vigan，这是一家为新兴世界模型业务提供数据的供应商。他说他知道 Physicl 的数据对他们正在构建的东西很有用，但他对具体是什么仍一无所知。“我希望他们能告诉我们更多。如果我们知道他们在做什么，我们就能构建出更有用的数据，”de Vigan 告诉我。
...
这种神秘感的部分原因在于“世界模型”这一概念的通用性。最简单的版本是世界的可导航地图，类似于驱动自动驾驶汽车的 AI 模型。但帮助 Waymo 在车流中穿梭的建模方法，同样可以帮助人形机器人搬运箱子，或者将几分钟的视频片段转化为可探索的环境。AMI 已经通过其 Nabia 合作伙伴关系涉足了制造业、生物医学、机器人技术，甚至是医生使用的 AI 软件。当然，它不可能同时追求所有这些领域——但也许其中一两个领域正在脱颖而出？
...
没人怀疑基于世界模型技术可以建立许多可行的业务——只要融资容易，就没有特别的压力去专注于某一个方向。事实上，不这样做也有充分的理由。如果 AMI 明天宣布他们已经构建了一个人形 OpenClaw 或下一代好莱坞渲染系统，许多其他实验室会突然对这个领域产生浓厚兴趣。很快，该实验室就会面临来自其他世界模型公司、新兴实验室，甚至 OpenAI 和 Anthropic 的潜在竞争。
...
在某种程度上，这是融资过于容易带来的负面影响。你的竞争对手也可以融资——同样的资金既让你能够低调研发，一旦市场路径变得清晰，也会资助许多潜在的竞争对手。但即使这种竞争不可避免，最好还是尽可能推迟它，这意味着对你正在构建的具体内容保持沉默。刘慈欣的粉丝会认出这是一个“黑暗森林”场景：如果你不知道森林里还有谁，最好不要引起注意。