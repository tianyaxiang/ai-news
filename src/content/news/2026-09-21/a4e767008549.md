...
originalUrl: "https://arstechnica.com/security/2026/09/an-undercover-google-analyst-infiltrated-a-notorious-supply-chain-hacking-gang/"
date: "2026-09-20T23:21:01.641Z"
---

# An undercover Google analyst infiltrated a notorious supply-chain hacking gang
# 谷歌卧底分析师渗透了一个臭名昭著的供应链黑客组织
...
在上个月两名涉嫌成员在澳大利亚被捕并受到指控之前，名为 TeamPCP 的黑客组织进行了一场史上罕见的黑客攻击狂潮。他们用恶意软件污染了数百个开源程序，窃取开发者账户以持续进行软件供应链攻击，甚至发布了一种以《沙丘》（Dune）为主题的自我传播蠕虫来自动化这一过程，最终入侵了超过一千家公司。
...
现在，谷歌威胁情报小组透露，在 TeamPCP 疯狂作案的关键时刻，该公司的一名卧底研究员已经渗透进该组织——这使得谷歌能够从内部监控其黑客行为，向受害者发出警告，甚至帮助阻止该组织利用这些受害者的企图。
...
在今天安全公司 SentinelOne 举办的 LABScon 研究会议上，谷歌威胁情报小组的研究员 Austin Larsen 将详细介绍该公司在 TeamPCP 前所未有的混乱供应链黑客攻击活动中，对其进行的调查及渗透过程。

According to Larsen, Google eventually followed a trail of operational security mistakes allegedly made by one of the two Australians now accused of being leading members of the hacker group and passed on key identifying details to law enforcement. The company also received intelligence from ShinyHunters, another infamous cybercriminal group that TeamPCP partnered with, but which later turned on the supply-chain hackers.

据 Larsen 称，谷歌最终追踪到了两名被指控为该黑客组织核心成员的澳大利亚人所犯下的操作安全错误，并将关键的身份识别细节移交给了执法部门。该公司还从 ShinyHunters 那里获得了情报，这是另一个与 TeamPCP 合作但后来反目成仇的臭名昭著的网络犯罪组织。

And perhaps most surprisingly, Larsen says that Google’s security subsidiary Mandiant had an undercover analyst—not himself—within the group’s inner circle from almost the beginning of TeamPCP’s time in the spotlight. “One of our personas had been working for many months to build trust with one of the actors that was invited to join TeamPCP, and so was added to the group,” Larsen told WIRED in an interview ahead of his LABScon talk. “So essentially, almost day one, Mandiant was watching everything behind the scenes.”

最令人惊讶的是，Larsen 表示，谷歌旗下的安全子公司 Mandiant 在 TeamPCP 进入公众视野之初，就已经有一名卧底分析师（并非他本人）潜伏在该组织的核心圈子中。“我们的一个虚拟身份花了几个月的时间与一名受邀加入 TeamPCP 的成员建立信任，并因此被拉入了该组织，”Larsen 在 LABScon 演讲前接受《连线》（WIRED）采访时说道。“所以本质上，从第一天起，Mandiant 就在幕后注视着一切。”
...
上个月底，Ruben Ian Thomson 和 Louis Michael Gaebler（均为 20 多岁的澳大利亚人）在澳大利亚警方与联邦调查局（FBI）的联合调查中被捕，并被指控犯有黑客罪。澳大利亚联邦警察（AFP）在一份新闻稿中将他们描述为 TeamPCP 的“主要参与者”（由于澳大利亚隐私法，新闻稿中未提及他们的姓名）。
...
该黑客组织似乎于 2025 年底首次出现在网络上，并因一系列肆无忌惮的级联供应链攻击而登上头条：它反复入侵开源软件以隐藏其恶意软件，随后利用这些软件劫持软件开发者的凭据，并将恶意代码植入到另一个广泛使用的工具中，形成了一个循环。
...
例如，从今年春天开始，TeamPCP 入侵了开源安全扫描器 Trivy、AI 应用程序接口工具 LiteLLM、Web 应用程序安全公司 Checkmarx 的基础设施、Web 应用库 TanStack 以及企业级 AI 平台 Mistral AI。这些反复的供应链攻击使该组织能够不断扩大受害者范围，最终让黑客入侵了开源代码仓库 GitHub、数据承包公司 Mercor，以及 OpenAI、欧盟委员会等机构的员工设备，还有许多未在公开报道中披露的受害者。
...
有时，该组织会部署一种名为“Mini Shai-Hulud”的蠕虫（以《沙丘》中的沙虫命名），以自动化其黑客攻击并扩大受害者规模。（这个名字似乎也指代了 2025 年 9 月黑客为尝试类似方法而设计的早期 Shai-Hulud 蠕虫，尽管目前尚不清楚 TeamPCP 或其任何涉嫌成员是否参与了那次早期的入侵活动。）
...
Larsen 现在表示，今年 3 月，就在 TeamPCP 开始其疯狂的供应链黑客攻击时，谷歌的卧底分析师受邀加入了黑客的核心圈子。该内部消息人士（Larsen 拒绝透露其姓名）是该组织约 12 名成员之一，他们可以访问 TeamPCP 称为“CanisterWorm”的核心聊天室。
...
曾任澳大利亚联邦警察分析师、现就职于一家澳大利亚电信公司威胁研究部门的 Michael Fletcher 表示，他当时曾就监控该组织成员和活动的方法与 Larsen 接触。Fletcher 回忆说，Larsen 回复时要求他谨慎对待这些黑客，因为其中一个是“友军”。“我当时心想，天哪，你们竟然这么早就打入内部了，”他说。
...
Larsen 表示，谷歌的卧底分析师获得了 TeamPCP 存储从众多受害者那里窃取的凭据服务器的访问权限：包括通过黑客攻击获得的用户名、密码和访问令牌，这些凭据似乎计划用于勒索目标公司。因此，谷歌团队决定采取行动警告受害者并阻止 TeamPCP 的勒索计划。“我的想法是：我们如何能尽快在更多损害发生之前破坏他们的行动？”Larsen 说。“去搞砸他们的计划。这就是我的目标。”
...
谷歌并没有直接向受害公司的凭据所有者发出警报（Larsen 表示，考虑到被入侵公司的数量庞大，这样做太耗时），而是首先联系了可以使用这些凭据的服务提供商，如亚马逊云科技（AWS）和微软，要求撤销这些凭据并防止黑客利用它们。Larsen 和他的团队向这些提供商以及受害者发送了数百封通知邮件，其中许多都得到了立即回复。Larsen 说，大约在同一时间，谷歌的可见性……