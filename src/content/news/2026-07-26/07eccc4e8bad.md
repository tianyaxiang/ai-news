...
originalUrl: "https://techcrunch.com/2026/07/24/prentis-new-ai-lab-co-founded-by-reid-hoffman-mark-pincus-in-talks-to-raise-100m/"
date: "2026-07-25T22:14:52.168Z"
---

# Prentis, new AI lab co-founded by Reid Hoffman, Mark Pincus in talks to raise $100M
# 由 Reid Hoffman 和 Mark Pincus 联合创立的 AI 新实验室 Prentis 正洽谈融资 1 亿美元
...
据两位知情人士透露，专注于计算机使用模型（computer use models）的 AI 研究实验室 Prentis 正洽谈以 10 亿美元的估值融资 1 亿美元。该实验室由连续创业者 Ritankar Das 以及科技界重量级人物 Reid Hoffman 和 Mark Pincus 共同创立。
...
Prentis 于今年 4 月成立，目前正在训练模型学习办公人员如何处理跨文档和系统的日常工作流程，目标是构建能够操控计算机以实现这些任务自动化的 AI 智能体。
...
Prentis 旨在开发针对客户需求定制的智能体，例如处理保险索赔和自动化关税退税异常，无需人工去翻找纸质文件。

The startup has already signed contracts worth up to $50 million with several customers, including healthcare management service organization, a manufacturer, and goods and clothing manufacturers, the two people familiar with the discussions tell TechCrunch.
据上述两位知情人士向 TechCrunch 透露，该初创公司已经与多家客户签署了价值高达 5000 万美元的合同，其中包括一家医疗保健管理服务机构、一家制造商以及多家商品和服装制造商。

This echoes investor materials obtained by TechCrunch that predict an estimated $75 million annualized run rate by the third quarter of this year. (Prentis’ pitch deck notes those figures reflect estimated annualized value based on a contracted fee equal to 20% of savings realized, not recognized revenue, and are “performance-dependent and subject to final execution.”)
这与 TechCrunch 获得的投资者材料相呼应，该材料预测到今年第三季度，公司的年化运行率将达到约 7500 万美元。（Prentis 的融资推介材料指出，这些数字反映的是基于合同费用（即实现节省额的 20%）估算的年化价值，而非已确认收入，且“取决于绩效并以最终执行为准”。）
...
据 Prentis 自称，其 Hive-32B 模型在两项计算机使用基准测试中表现优于包括 OpenAI 的 GPT-5.4 和 Anthropic 的 Claude Opus 4.6 在内的竞争对手。这两项测试分别是：衡量在真实 Windows 应用程序上端到端任务完成情况的 WindowsAgentArena，以及测试模型定位屏幕上正确控件能力的 ScreenSpot-v2。
...
在其融资推介材料中，该公司认为其优势在于运行着一个规模更小、成本更低的模型。事实上，它声称每项任务的成本比前沿 API 低约 10 倍，并表示在日常工作流程中部署更具经济性。TechCrunch 尚未独立核实该公司的基准测试结果。
...
这家初创公司押注自动化日常办公任务将很快超越编程，成为 AI 最大的应用场景，但这是一个竞争激烈的市场。其中一位消息人士称，Anthropic、OpenAI 以及 Mira Murati 的 Thinking Machines Lab 也都在致力于开发用于计算机操作的 AI 智能体。Anthropic 此前也一直在直接收购该领域的人才——今年早些时候，它收购了西雅图计算机使用初创公司 Vercept，吸纳了其创始人并关闭了该公司的产品。
...
他在从剑桥大学的 AI 博士项目退学后于 2014 年创立了 Titan，此前他曾是盖茨剑桥学者。Das 将 Titan 描述为一种刻意回归伯克希尔·哈撒韦公司（Berkshire Hathaway）那种老式控股公司模式的尝试，即由自身的退出收益而非外部有限合伙人提供资金。
...
对于另外两位联合创始人来说，Prentis 算是一个副业。LinkedIn 联合创始人兼 Greylock 合伙人 Hoffman 上个月表示，在担任微软董事近十年后，他将卸任，以便以“创始人模式”投入到他支持的 AI 药物研发初创公司 Manas AI 中；他曾是 OpenAI 的早期投资者，并与 Mustafa Suleyman 共同创立了 Inflection AI，随后微软在 2024 年吸纳了该团队的大部分成员。
...
Zynga 创始人 Pincus 目前与 Hoffman 一起经营投资公司 Reinvent Capital，Hoffman 担任高级顾问。Pincus 上个月还出版了回忆录《Life at the Speed of Play》。
